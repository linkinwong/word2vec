...
################################################################
    script_file = code_dir + 'preprocessor2.py'
################################################################
    path = source_path
...
# def ProcessLastLabel(path,output_folder, sep):
#     output_path = output_folder+ "/ssrFeatureStep1/" + os.path.basename(path) + '.noSpaceInFiled'
#     output_file_obj = open(output_path,'w')
...
def GetSsrFeature(path, dest_dir,  sep):
    output_path = dest_dir+ '/' + os.path.basename(path) + '.ssrFeature'
    output_file_obj = open(output_path,'w')
...
if __name__ == '__main__':
    ...
    ## dest_folder_fullpath = MakeNewFolderVersionHigher('.', 'processFolder')
