...
def SentAccuracy(source_path, dest_path):
    ...
    for root, dirs, files in os.walk(path):
        for filespath in files:
            if 'result.txt' in filespath:
                result_path = os.path.join(root, filespath)
            elif 'te.txt' in filespath:
                test_path = os.path.join(root, filespath)


    class_path ="/home/linlin/time/0903_classify_false_start/1003_raw_features/processDir_45_ssr_rep_dump/classificationStep4"
    result_path = class_path + '/' +  'result.txt'
    model_path = class_path + '/' +  'ssr_rep_no_ngram.model'
...
if __name__ == '__main__':
    ...
    output_root_dir= "/home/linlin/time/0903_classify_false_start/1003_raw_features/processDir_45_ssr_rep_dump"
    result_dir ="/home/linlin/time/0903_classify_false_start/1003_raw_features/processDir_45_ssr_rep_dump/attributesStep3"
